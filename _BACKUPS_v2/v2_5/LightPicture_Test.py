...
class TestConstructor_Coordinate(unittest.TestCase):
    ...
    def test_iterable(self):
        """
            Calling Coordinates class with iterable key conaining simple types
        """
        c0 = Coordinates([1])
        self.assertIsNot(c0, None)
        self.assertIsInstance(c0, Coordinates)
    ...
    def test_iterable_specific(self):
        """
            Calling Coordinates class with iterable key containing specific types
        """
...
class TestConstructor_Vertex(unittest.TestCase):
    ...
    def test_iterable_simple(self):
        """
            Calling Vertex class with iterable key containing simple types
        """
        v0 = Vertex([1])
        self.assertIsNot(v0, None)
        self.assertIsInstance(v0, Vertex)
    ...
    def test_iterable_specific(self):
        """
            Calling Vertex class with iterable key containing specific types
        """
        ...
        # Action: Vertex class call with Coordinate object as key
        # Expects: Vertex object is 'parent' of Coordinate object
        c_c0 = Coordinates([11, 12, 13])
        c_v0 = Vertex(c_c0)
        c_r0 = c_c0.parents()
        c_pass = c_v0 in c_r0
        self.assertIs(c_pass, True)
