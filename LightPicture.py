""" VERSION INFO
    ...
    History:
        v_4_6
            Cosmetic changes for repo release
        v_4_5
    ...
    def __init_height_map(self):
        ...
        for x in range(size[0]):
            ...
            for y in range(size[1]):
                ...
                # TODO: only for testing - divide z height by factor
                pixel_height = int(pixel_height / 10) + 1
                # pixel_height = int(pixel_height / 8)  # 3,2mm thick, 32 shades - quality very nice
                # pixel_height = int(pixel_height / 10)  # 2,5mm thick, 25 shades - quality very nice
                ...
                if pixel_height > self._height_max:
                    self._height_max = pixel_height  # this +1 seems crucial :D... just kidding, I know why
        self._height_max += 2
...
def try_me():
    ...
    image = Image.open('sample_image3.bmp')
    print('Bitmap file open')

    t0 = time.perf_counter()
    ic = ImageConverter(image, [1.7, 1.7, 0.1])
